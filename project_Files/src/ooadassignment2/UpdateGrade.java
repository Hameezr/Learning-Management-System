...
public class UpdateGrade extends javax.swing.JFrame {
     ...
     */
    public UpdateGrade(String tid) throws SQLException {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(course!="" && section!="" && student!="")
        {
            ...
            try {
                int x=obj.grade(course, student, grade);
                if(x>0)
                    JOptionPane.showMessageDialog(rootPane, "Grade Uploaded", "Done", HEIGHT);
                else
                        JOptionPane.showMessageDialog(rootPane, "Grade not Uploaded", "Error", HEIGHT);
